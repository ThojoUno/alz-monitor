...
module Deploy_Alerting_Management '../../infra-as-code/bicep/modules/policy/assignments/policyAssignmentManagementGroup.bicep' = {
  name: '${uniqueString(deployment().name)}-Alerting-Identity_VM'
  params: {
    parPolicyAssignmentDefinitionId: '/providers/Microsoft.Management/managementGroups/${parPolicyPseudoRootMgmtGroup}/providers/Microsoft.Authorization/policySetDefinitions/Alerting-VM'
    parPolicyAssignmentDisplayName: 'ALZ Monitoring Alerts for Identity virtual machines'
    parPolicyAssignmentName: 'ALZ-Monitor_Identity_VM'
    parPolicyAssignmentDescription: 'Initiative to deploy alerts relevant to the virtual machines in Identity Management group'
