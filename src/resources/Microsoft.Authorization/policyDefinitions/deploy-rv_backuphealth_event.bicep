...
module BackupHealthAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-rvbhe-policyDefinitions'
    params: {
        name: 'Deploy_RecoveryVault_BackupHealthEvent_Alert'
        displayName: 'Deploy RV Backup Health Event Alerts'
         description: 'Policy to audit/update Recovery Vault Backup Health Event Alerting'
                                ...
                                resources: [
                                    {
                                        ...
                                        properties: {
                                            description: 'Metric Alert for RSV Backup Health Event '
